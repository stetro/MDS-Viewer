var FileViewerController = function ($scope, $http, $injector) {
    ...
    $scope.deleteFile = function (file) {
        $http({
            method: 'DELETE',
            url: '/mdsviewer/api/file/?path=' + file.data.fullpath
        }).success(function (data, status, headers, config) {
    ...
    $scope.deleteFolder = function (currentFolder) {
        $http({
            method: 'DELETE',
            url: '/mdsviewer/api/folder/?path=' + currentFolder.data.fullpath
        }).success(function (data, status, headers, config) {
    ...
    $scope.loadVersions = function () {
        ...
        $http({
            method: 'GET',
            url: '/mdsviewer/api/file/versions/?path=' + $scope.currentFile.data.fullpath
        }).success(function (data, status, headers, config) {
    ...
    $scope.loadCodeOfVersion = function () {
        ...
        $http({
            method: 'GET',
            url: '/mdsviewer/api/file/' + version + '?path=' + $scope.currentFile.data.fullpath
        }).success(function (data, status, headers, config) {
                $scope.code = data;
    ...
    $scope.executeDiff = function () {
        ...
        $http({
            method: 'GET',
            url: '/mdsviewer/api/file/diff/?path=' + path + '&firstVersion=' + firstVersion + '&secondVersion=' + secondVersion
        }).success(function (data, status, headers, config) {
    ...
    var loadCodeOf = function (path) {
        ...
        $http({
            method: 'GET',
            url: '/mdsviewer/api/file/?path=' + path
        }).success(function (data, status, headers, config) {
                $scope.code = data;
                $scope.currentFileVersions = null;
                refreshCode(data);
